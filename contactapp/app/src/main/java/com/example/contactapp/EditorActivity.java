...
public class EditorActivity<D> extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, android.app.LoaderManager.LoaderCallbacks<D> {
    ...
    private void saveContact() {
        ...
        if (mCurrentContactUri == null && TextUtils.isEmpty(name)
                && TextUtils.isEmpty(email) && TextUtils.isEmpty(phone) && mType.equals(Contract.ContactEntry.TYPEOFCONTACT_PERSONAL) && mPhotoUri == null) {
