...
public class Provider extends ContentProvider {
    ...
    private static final Object Contract = new Object();

    static {
        sUriMatcher.addURI(Contract.ContactEntry, Contract.PATH_CONTACTS, CONTACTS);
        // this hashtag represents the row id number
        sUriMatcher.addURI(Contract.ContactEntry, Contract.PATH_CONTACTS + "/#", CONTACTS_ID);
